        ...
        <section>
          ...
          <div className="bg-[#F7F2FA] dark:bg-[#2B2930] rounded-[28px] shadow-sm p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              {status === 'error' && (
                <div className="flex gap-2 items-start bg-red-50 dark:bg-red-900/10 p-3 rounded-xl border border-red-100 dark:border-red-900/20 animate-in fade-in slide-in-from-top-2 overflow-hidden">
                  <AlertCircle size={16} className="text-red-600 dark:text-red-400 shrink-0 mt-0.5" />
                  <div className="overflow-x-auto">
                    <pre className="text-[11px] text-red-700 dark:text-red-300 font-mono whitespace-pre-wrap leading-relaxed">
